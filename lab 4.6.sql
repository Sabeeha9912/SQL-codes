...
if we change minor changings in your code that is detectibleif we change minor changings in your code that is detectibleTABLE OrderDetails(
    OrderID INT,
    ProductID INT,
    Quantity INT,
...
LEFT JOIN Orders o 
    ...
    AND o.OrderDate >= '2026-07-01'  -- start of last 6 months
    AND o.OrderDate <= '2026-12-31'  -- end of year
