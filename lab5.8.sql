...
(1003, 1, 1, 1, '2026-02-15'),
(1004, 2, 2, 1, '2026-02-20'),
(1005, 2, 2, 1, '2026-03-05'),
(1006, 3, 2, 1, '2026-03-10'),
(1007, 4, 3, 2, '2026-04-12'),
(1008, 4, 3, 2, '2026-04-18'),
(1009, 4, 3, 3, '2026-05-20'),
(1010, 4, 3, 4, '2026-05-25');
...
-- h) Number of orders per month
SELECT DATE_FORMAT(OrderDate, '%Y-%m') AS OrderMonth, COUNT(OrderID) AS Total_Orders
FROM Orders
GROUP BY OrderMonth
ORDER BY OrderMonth;